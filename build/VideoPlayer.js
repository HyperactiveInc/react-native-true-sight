...
export default class VideoPlayer extends React.PureComponent {
    constructor(props) {
        ...
        this.toggleFullscreen = () => this.player.presentFullscreenPlayer();
    ...
    render() {
        const { loader, repeat, middleControlsBar, middleControlsBarProps, bottomControlsBarProps, bottomControlsBar, source, onError } = this.props;
